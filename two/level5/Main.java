...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int numOfCustomers = Integer.parseInt(args[3]); //also number of ARRIVAL EVENTS
        double arrivalRate = Double.parseDouble(args[4]);
        double serviceRate =  Double.parseDouble(args[5]);
        double restRate = Double.parseDouble(args[6]);
        double restProb = Double.parseDouble(args[7]);
