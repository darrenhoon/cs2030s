...
public class WaitEvent extends Event {
    ...
    /**
     * Wait event where customer's next event
     * is Serve Event and customer's queue
     * boolean is made true.
     */
    ...
    public String toString() {
        ...
        if (this.customer() instanceof Greedy) {
            message = String.format("%.3f %d(greedy) waits to be served by ", arrivalTime, c);
        } else {
            message = String.format("%.3f %d waits to be served by ", arrivalTime, c);
        }
